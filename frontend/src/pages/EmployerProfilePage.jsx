...
// import { useParams } from "@solidjs/router"; // to get the dynamic ID from the URL
// import { fetchEmployerProfile } from "../api/employerProfile"; // We'll create this function to fetch profile
...
//       {profile() && (
//         <div>
//           <h1 class="text-3xl font-bold mb-4">{profile().company_name}</h1>
//           <p><strong>Company Description:</strong> {profile().description}</p>
//           <p><strong>Website:</strong> <a href={profile().website} target="_blank">{profile().website}</a></p>
//           <p><strong>Location:</strong> {profile().location}</p>
//           {/* You can add more fields based on your EmployerProfile model */}
//         </div>
//       )}
//     </div>
//   );
